    ...
    if (userData.userName == userID && userData.userPass == userPass) {
        ...
        while (flag == true) {
            ...
            if (selectedFunction.myFunction == chalk.blueBright("Transfer")) {
                ...
                if (transfer.money > 0 && transfer.money <= 30000) {
                    if (myBalance >= transfer.money) {
                        ...
                        console.log("-------------------------------------------------------------");
                        console.log("");
                        console.log(chalk.bold(chalk.green(`Amount transfered: ${transfer.money}`)));
                        console.log(chalk.blueBright(`Your remaaining balance is: ${myBalance}`));
                        console.log("");
                    }
                    else {
            ...
            if (selectedFunction.myFunction ==
                chalk.cyanBright("Bill payment (coming soon)")) {
                console.log(chalk.bold(chalk.yellow("Sorry this is option is not avalaible right now")));
            }
        }
    }
    else {
        count = count + 1;
        console.log(chalk.bgRed("Invalid username or security pin. Please try again"));
    }
    if (count == 3) {
        console.log("");
